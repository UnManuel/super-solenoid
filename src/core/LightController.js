...
export default class LightController
{
    constructor(three, light)
    {
        ...
        this.pivot = new this.three.Vector3();
        ...
        this.light.target = this.smoothTarget;
    ...
    stop()
    {
        ...
        this.pivot.copy(this.light.position);
    }
    ...
    update(deltaTime)
    {
        if(!this.paused)
        {
            ...
            if(this.point == null && this.curve == null)
                this.updateLightPosition(deltaTime);
            ...
            if(this.point != null)
            {
                ...
                if(this.time >= 0)
                {
                    if(this.prevPoint == null)
                    {
                        ...
                        this.prevPoint.copy(this.light.position);
                    }
                    ...
                    this.light.position.copy(this.pivot);
    ...
    {
        const toTarget = new this.three.Vector3().subVectors(this.pivot, this.light.position);
        ...
        this.velocityCopy.copy(this.velocity);
        this.light.position.add(this.velocityCopy.multiplyScalar(deltaTime));
    }
